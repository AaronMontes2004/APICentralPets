import { verifyIdReservation } from './../../libs/queriesValidation/reservationQueryValidation';
import pool from "./../../database";
import { body, param } from "express-validator";

export const addReservationValidation = [
    body("dateReservation").notEmpty().withMessage("La fecha de reserva no puede estar vacio").isDate().withMessage("La fecha ingresada no tiene el formato correcto"),
