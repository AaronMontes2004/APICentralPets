...
export const findByIdAppointmentQuery: string = "SELECT * FROM cita c INNER JOIN reservacion r ON c.idReservacion = r.idReservacion INNER JOIN tipo_cita tc ON c.idTipoCita = tc.idTipoCita WHERE idCita = ?"

export const findAppointmentByIdPetQuery: string = "SELECT * FROM cita c INNER JOIN reservacion r ON c.idReservacion = r.idReservacion INNER JOIN tipo_cita tc ON c.idTipoCita = tc.idTipoCita WHERE idMascota = ?"